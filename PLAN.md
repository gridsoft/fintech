...
- [ ] Seed на македонски контен план (класи 0–9, барем основните сметки за почеток: парични средства, побарувања, залихи, основни средства, обврски кон добавувачи, капитал, приходи од продажба, трошоци)
- [ ] `AccountRepository`: CRUD
- [ ] Едноставен UI: листа на сметки, форма за додавање/уредување
...
- [ ] **Trial balance** (бруто биланс) — збир на debit/credit по сметка, проверка дека вкупно се балансира
- [ ] **Главна книга по сметка** — веќе делумно готово од Фаза 2, само форматирано како извештај
- [ ] **Едноставна ДДВ евиденција** — излезен ДДВ (од фактури) наспроти влезен ДДВ (кога додадеш модул за влезни фактури/трошоци), без автоматска пријава кон УЈП засега
- [ ] **Отворени ставки по партнер** (кој колку должи/побарува)
