...
class PaymentMatchingServiceTest extends TestCase
{
    ...
    public function test_full_payment_matches_sales_invoice_and_marks_it_paid(): void
    {
        ...
        $transactionId = $this->service->addTransaction($this->statementId, '2026-01-16', 'Уплата купувач', '1180.00', 'in', $this->customerId);
        $this->service->matchToSalesInvoice($transactionId, $invoiceId);
    ...
    public function test_partial_payment_leaves_invoice_open_with_reduced_outstanding_balance(): void
    {
        ...
        $transactionId = $this->service->addTransaction($this->statementId, '2026-01-16', 'Делумна уплата', '700.00', 'in', $this->customerId);
        $this->service->matchToSalesInvoice($transactionId, $invoiceId);
    ...
    public function test_it_rejects_overpayment_beyond_outstanding_balance(): void
    {
        ...
        $transactionId = $this->service->addTransaction($this->statementId, '2026-01-16', 'Преголема уплата', '5000.00', 'in', $this->customerId);
    ...
    public function test_it_rejects_matching_an_out_transaction_to_a_sales_invoice(): void
    {
        ...
        $transactionId = $this->service->addTransaction($this->statementId, '2026-01-16', 'Погрешна насока', '1180.00', 'out', $this->customerId);
    ...
    public function test_full_payment_matches_purchase_invoice_and_marks_it_paid(): void
    {
        ...
        $transactionId = $this->service->addTransaction($this->statementId, '2026-01-16', 'Исплата добавувач', '1180.00', 'out', $this->supplierId);
        $this->service->matchToPurchaseInvoice($transactionId, $purchaseInvoiceId);
    ...
    public function test_it_cannot_rematch_an_already_matched_transaction(): void
    {
        ...
        $transactionId = $this->service->addTransaction($this->statementId, '2026-01-16', 'Уплата', '1180.00', 'in', $this->customerId);
        $this->service->matchToSalesInvoice($transactionId, $invoiceId);
