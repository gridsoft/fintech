<?php ob_start(); ?>
<a href="/product-categories/create" class="btn btn-primary">
                        ...
                        <td class="text-end">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><a class="dropdown-item" href="/product-categories/<?= $category->id ?>/edit"><i class="bi bi-pencil me-2"></i>Уреди</a></li>
                                    <li><hr class="dropdown-divider"></li>
                                    <li>
                                        <form action="/product-categories/<?= $category->id ?>/delete" method="post"
