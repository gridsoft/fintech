            ...
            <tbody>
                ...
                <?php foreach ($categories as $category): ?>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <a href="/product-categories/<?= $category->id ?>/edit" class="btn btn-sm btn-outline-secondary">
                                <i class="bi bi-pencil"></i>
                            </a>
                            <form action="/product-categories/<?= $category->id ?>/delete" method="post" class="d-inline"
